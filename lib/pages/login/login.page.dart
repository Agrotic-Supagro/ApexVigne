  ...
  Widget build(BuildContext context) {
    return FlutterLogin(
      ...
      messages: LoginMessages(
        ...
        confirmationCodeHint: AppLocalizations.of(context)!.hintConfirmationCode,
        setPasswordButton: AppLocalizations.of(context)!.actionSetPassword,
        confirmationCodeValidationError: AppLocalizations.of(context)!.infoConfirmationCodeValidationError,
